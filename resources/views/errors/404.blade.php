...
<div class="d-flex flex-column flex-root">
    ...
    <!--begin::Container-->
        ...
        <div class="error error-4 d-flex flex-row-fluid bgi-size-cover bgi-position-center"
             style="background-image: url({{asset('assets/media/error/bg4.jpg')}});">
            <!--begin::Content-->
            <div
                ...
                <p class="error-subtitle text-success font-weight-boldest mb-10">خطأ</p>
                <p class="display-4 text-danger font-weight-boldest mt-md-0 line-height-md">الصفحة المطلوبة غير
                    موجودة</p>
                <a class="btn btn-primary" href="{{URL::previous()}}">رجوع للصفحة السابقة <i class="fa fa-arrow-right"></i> </a>
            </div>
            <!--end::Content-->
        </div>
        <!--end::Dashboard-->
