                    ...
                    <div class="card card-custom card-shadowless rounded-top-0">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div class=" mt-5">
                                <h3 class="card-label">التصنيفات
                                    <div class="text-muted pt-2 font-size-sm">تعديل تصنيف </div>
                                </h3>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" value="{{old('name',$category->name)}}" placeholder="ادخل التصنيف">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                       <span class="switch switch-outline switch-icon switch-danger">
                                        <label>
                                         <input type="checkbox" @if(old('status') == "on" || $category->status == 'active') checked @endif name="status"/>
                                         <span></span>
                                        </label>
                                       </span>
                                </div>
