        ...
        <div class="card card-custom card-transparent">
            <div class="card-body p-0">
                ...
                <form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_form"
                      method="post" action="{{route('authors.update',$author->id)}}"
                        ...
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div class=" mt-5">
                                <h3 class="card-label">المؤلفون
                                    <div class="text-muted pt-2 font-size-sm">تعديل المؤلف </div>
                                </h3>
                            </div>
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <div class="image-input image-input-outline" id="kt_image_1">
                                        <div class="image-input-wrapper"
                                             style="background-image: url({{asset('uploads/authors/'.$author->image?:'assets/media/users/blank.png')}})"></div>
                            ...
                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label text-left">اسم المؤلف
                                    <span class="text-danger">*</span></label>
                                <div class="col-lg-9 col-xl-9">
                                    <input type="text" class="form-control" name="name" value="{{old('name',$author->name)}}" placeholder="ادخل اسم المؤلف">
                            ...
                            <div class="form-group row cke_rtl" dir="rtl">
                                <label class="col-xl-3 col-lg-3 col-form-label text-left">السيرة الذاتية للمؤلف
                                    <span class="text-danger">*</span></label>
                                <div class="col-lg-9 col-xl-9">
                                    <textarea name="bio" id="kt-ckeditor-1">{{old('bio',$author->bio)}}</textarea>
                                    <div class="fv-plugins-message-container">
                                        @error('bio')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                       <span class="switch switch-outline switch-icon switch-danger">
                                        <label>
                                         <input type="checkbox" @if(old('status') == "on" || $author->status == 'active') checked @endif name="status"/>
                                         <span></span>
                                        </label>
                                       </span>
                                </div>
