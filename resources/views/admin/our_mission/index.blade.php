        ...
        <div class="card card-custom card-transparent">
            <div class="card-body p-0">
                ...
                <form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_form"
                      method="post" action="{{route('settings.postMission')}}"
                    ...
                    <div class="card card-custom card-shadowless rounded-top-0">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div class=" mt-5">
                                <h3 class="card-label">مهمتنا
                                    <div class="text-muted pt-2 font-size-sm">تعديل بيانات مهمتنا </div>
                                </h3>
                            </div>
                            ...
                            <div class=" mt-5">
                                <div>
                                    ...
                                    <a href="{{route('settings.getMission')}}" id="next-step"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row cke_rtl" dir="rtl">
                                <label class="col-xl-3 col-lg-3 col-form-label text-left">مهمتنا
                                    <span class="text-danger">*</span></label>
                                <div class="col-lg-9 col-xl-9">
                                    <textarea name="mission" id="kt-ckeditor-1">{{old('mission',@$page['mission'])}}</textarea>
