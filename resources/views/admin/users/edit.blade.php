                ...
                <form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_form"
                    ...
                    <div class="card card-custom card-shadowless rounded-top-0">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div class=" mt-5">
                                <h3 class="card-label">المستخدمون
                                    <div class="text-muted pt-2 font-size-sm">تعديل بيانات المستخدم </div>
                                </h3>
                            </div>
                            ...
                            <div class=" mt-5">
                                <div>
                                    ...
                                    <a href="{{route('users.index')}}" id="next-step"
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label text-left">صورة المستخدم
                                    <span class="text-danger">*</span></label>
                                <div class="col-lg-9 col-xl-9">
                                    <div class="image-input image-input-outline" id="kt_image_1">
                                        <div class="image-input-wrapper"
                                             style="background-image: url({{asset('uploads/users/'.$user->image?:'assets/media/users/blank.png')}})"></div>
                            ...
                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label text-left"> الاسم
                                    <span class="text-danger">*</span></label>
                                <div class="col-lg-9 col-xl-9">
                                    <input type="text" class="form-control" name="name" value="{{old('name',$user->name)}}" placeholder="ادخل اسم ">
                            ...
                            <div class="form-group row">
                                <label class="col-xl-3 col-lg-3 col-form-label text-left">الجنس <span
