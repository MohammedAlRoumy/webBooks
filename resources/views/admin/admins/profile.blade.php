        ...
        <div class="card card-custom card-transparent">
            <div class="card-body p-0">
                ...
                <form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_form"
                      method="post" action="{{route('admins.updateProfile',Auth::guard('admin')->user()->id)}}"
                        ...
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div class=" mt-5">
                                <h3 class="card-label">الادارة
                                    <div class="text-muted pt-2 font-size-sm">تعديل بياناتي</div>
                                </h3>
                            </div>
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <div class="image-input image-input-outline" id="kt_image_1">
                                        <div class="image-input-wrapper"
                                             style="background-image: url({{isset(Auth::guard('admin')->user()->image)?asset('uploads/admins/'.Auth::guard('admin')->user()->image ):asset('assets/media/users/blank.png')}})"></div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <input type="text" class="form-control" name="name"
                                           value="{{old('name',Auth::guard('admin')->user()->name)}}" placeholder="ادخل اسم ">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9 col-xl-9">
                                    <input type="email" class="form-control" name="email"
                                           value="{{old('email',Auth::guard('admin')->user()->email)}}" placeholder="ادخل البريد الالكتروني ">
