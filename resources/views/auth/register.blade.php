...
<!--                <a href="" class="fs-4 text-dark text-decoration-none">Double header</a>-->
                <a href="" class=" text-dark text-decoration-none"><img src="assets/dist/images/logo.png" alt=""
                                                                        width="80"></a>
            </span>
                        ...
                        <form class="" action="{{route('register')}}" method="post">
                            ...
                            <div class="form-group d-flex flex-wrap justify-content-between align-items-center">
                                <div class="form-check mb-3">
                                    ...
                                    <label class="form-check-label" for="exampleCheck1">أوافق على شروط الاستخدام</label>
                                </div>
                                <button type="submit" class="btn btn-primary mb-3">إنشاء حساب</button>
                            </div>
                            <hr>
                            <div class=" d-flex justify-content-center mt-4">
                                <button type="submit" class="btn btn-primary"> إنشاء عبر فيسبوك <i
                                        class="fa fa-facebook"></i>
                                </button>
                            </div>

                            <p class="mt-4 text-center"> لديك حساب بالفعل؟ <a href="{{route('login')}}"
                                                                              class="text-primary text-decoration-none">تسجيل
                                    دخول</a></p>
            ...
            <div class="col-md-3">
                <a href=""
                   class="d-flex flex-fill align-items-center mb-lg-0 me-lg-auto text-white text-decoration-none">
                    <span class="fs-4"><img src="{{asset('frontend/assets/dist/images/logo.png')}}" alt=""
                                            width="80"></span>
                </a>
                <hr>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="">
                    <div class="mb-2">
                        <label for="nameu" class="form-label">الاسم</label>
